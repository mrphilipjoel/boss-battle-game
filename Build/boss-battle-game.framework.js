...
var ASM_CONSTS = {
  4592480: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 4592541: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 4592605: function() {return Module.webglContextAttributes.powerPreference;},  
 4592663: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 4592718: function($0) {performance.now = function() { return $0; };},  
 4592766: function($0) {performance.now = function() { return $0; };},  
 4592814: function() {performance.now = Module['emscripten_get_now_backup'];}
};
  ...
  function _IsStreamModeInternal() {
      if (!window.Playroom) {
        console.error(
          "Playroom library is not loaded. Please make sure to call InsertCoin first."
        );
  ...
  function _WaitForPlayerStateInternal(playerId, stateKey, onStateSetCallback) {
      if (!window.Playroom) {
        console.error("Playroom library is not loaded. Please make sure to call InsertCoin first.");
        reject("Playroom library not loaded");
        return;
...
var asmLibraryArg = {
  ...
  "IsStreamModeInternal": _IsStreamModeInternal,
